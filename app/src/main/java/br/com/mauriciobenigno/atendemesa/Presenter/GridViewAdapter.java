...
public class GridViewAdapter extends ArrayAdapter <Mesa>{
    public GridViewAdapter(@NonNull Context context, int resource, @NonNull List<Mesa> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        if(v==null)
        {
            ...
            v = inflater.inflate(R.layout.grid_mesa, null);
        }
